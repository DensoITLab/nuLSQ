...
def cifar_dataloaders(batch_size, num_workers, num_train=50000, num_val=10000, num_test=10000):
    ...
    org_trainset = torchvision.datasets.CIFAR100(root='./data', train=True,  download=False, transform=transform_train)
    org_testset  = torchvision.datasets.CIFAR100(root='./data', train=False, download=False, transform=transform_test)
